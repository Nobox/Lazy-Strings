...
class LazyValidator
{
     ...
     *
     * Ex: https://docs.google.com/spreadsheets/d/1V_cHt5Fe4x9XwVepvlXB39sqKXD3xs_QbM-NppkrE4A/export?format=csv
     *
     * @param type string
     * @return boolean
     **/
    ...
    {
        $pattern = '/https:\/\/docs\.google\.com\/spreadsheets\/d\/.*\/export\?format=csv/';
